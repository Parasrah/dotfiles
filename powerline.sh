...
__powerline() {
    ...
    # TODO: Conditionally check this so it still works on unix
    ...
    ps1() {
        ...
        local patterns=("^/home/${USER}/$" "/home/${USER}" "^/mnt/c/Users/BradPfannmuller/$" "/mnt/c/Users/BradPfannmuller")
        local replacements=("~" "~" "%" "%")
        local pwd=$PWD
        for i in ${!patterns[@]}; do
            pwd="${pwd/${patterns[$i]}/${replacements[$i]}}"
        done
